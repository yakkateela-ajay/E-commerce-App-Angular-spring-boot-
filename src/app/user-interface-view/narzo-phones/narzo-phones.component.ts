...
@Component({
  selector: 'app-narzo-phones',
  templateUrl: './narzo-phones.component.html',
  styleUrls: ['./narzo-phones.component.css']
})
export class NarzoPhonesComponent implements OnInit {
